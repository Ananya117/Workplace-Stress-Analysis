# -*- coding: utf-8 -*-
"""CEAT - stacked catboost + tablenet (dataset2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1W9HXio6uUrSPsGXczM19DJslseQZ4QTq
"""
...
# ✅ Define models
tabnet_model = TabNetWrapper(cat_idxs=cat_idxs, cat_dims=cat_dims)
...
stack_model = StackingClassifier(
    estimators=[('tabnet', tabnet_model), ('catboost', catboost_model)],
...
print(f"\n🔥 Highest Accuracy Achieved: {acc:.4f}")
...
# ✅ SHAP Explainability (CatBoost only)
